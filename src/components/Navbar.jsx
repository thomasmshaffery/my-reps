...
function Navbar() {
  return (
    <div className="sticky top-0 w-dvw h-16 border-b-1 border-b-lines dark:border-b-dark-content bg-light-bg/50 dark:bg-dark-bg/50 backdrop-filter backdrop-blur-lg">
